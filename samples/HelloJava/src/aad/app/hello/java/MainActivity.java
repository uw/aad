...
public class MainActivity extends Activity {
	...
	private static final String TAG = "AAD HelloJava";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		java_Access();
		java_Block();
		java_AnonymousClasses();
		java_Control();
		java_Interfaces();
	}

	/** Examples of access methods */
	private void java_Access() {

		Log.d(TAG, "presentationJavaRefresher_Access()");

		float pi = Utility.getPI();
		Log.d(TAG, "The value of PI is " + pi); // String conversion on
												// concatenation
		Log.d(TAG, "The value of PI is " + String.valueOf(pi)); // Explicit
																// String
																// conversion
	}

	/** Examples of Blocks */
	private void java_Block() {
	...
	private void java_AnonymousClasses() {
	...
	private void java_Interfaces() {
		...
		for (ISellable item : sellableItems) {
			Log.i(TAG,
					"Item in collection: " + item.getName() + " : " + item.getPrice() + "c");
		}
