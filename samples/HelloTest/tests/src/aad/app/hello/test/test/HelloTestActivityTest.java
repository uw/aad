...
import aad.app.hello.test.HelloTestActivity;
...
public class HelloTestActivityTest extends ActivityInstrumentationTestCase2<HelloTestActivity> {
    ...
    public HelloTestActivityTest() {
        ...
        super("aad.app.hello.test.HelloTestActivity", HelloTestActivity.class);
    }
    ...
    protected void setUp() throws Exception {
        ...
        b1 = (Button) mActivity.findViewById(aad.app.hello.test.R.id.btn1);
        b2 = (Button) mActivity.findViewById(aad.app.hello.test.R.id.btn2);
        b3 = (Button) mActivity.findViewById(aad.app.hello.test.R.id.btn3);
        b4 = (Button) mActivity.findViewById(aad.app.hello.test.R.id.btn4);

        mEditText = (EditText) mActivity.findViewById(aad.app.hello.test.R.id.mainEditText);
    }
