...
package aad.app.hello.message;

import aad.app.hello.message.R;
...
public class MainActivity extends Activity {
    ...
    private class CustomTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            Thread.currentThread().setName("CustomTask");
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addText("Called from " + Thread.currentThread().getName() + " thread, mMainHandler hash: " + mMainHandler.hashCode());
